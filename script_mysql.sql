...
--   CREAR BASE DE DATOS
------------------------------------------------------------
CREATE DATABASE IF NOT EXISTS Mathleague;
USE Mathleague;
...
CREATE TABLE sesionesJuego (
    id_juegos_sesion INT AUTO_INCREMENT PRIMARY KEY,
...
VALUES
(NOW(), 3600, 150, 10, 500, 5, 1, 1),
(NOW(), 1800, 75, 20, 150, 10, 0, 2);
